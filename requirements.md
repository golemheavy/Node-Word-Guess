# Node-Word-Guess
This is another javascript hangman app, but this time it is in nodejs.

The requirements are below. This node js application is intended to demonstrate the use of constructors.
